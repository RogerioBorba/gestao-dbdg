...
<form class="relative " on:submit|preventDefault={handleSubmit}>
    ...
    <div class="flex mt-4 relative text-gray-700">
        ...
        <button class="focus:outline-none bg-grey-light hover:bg-grey text-grey-darkest font-bold px-1 rounded inline-flex items-center hover:bg-gray-200" on:click|preventDefault={btnSearchClicked} title="Buscar camadas">
        ...
        <button class="focus:outline-none bg-grey-light hover:bg-grey text-grey-darkest font-bold  px-1 rounded inline-flex items-center hover:bg-gray-200" on:click|preventDefault={btnClearClicked} title="Limpar camadas">
