  ...
  <csw:Query typeNames="csw:Record"> 
    ...
    async function btnCatalogoClicked() {
        ...
        try {
            ...
            console.log("Erro na requisição em protocolo-wms-quantidade")
            console.log(error)
        }
    }
</script>
...
<p class="mt-2 text-lg text-blue-600"><span class="">Quantidade de metadados com o protocolo WMS:</span> {qtd}</p>
